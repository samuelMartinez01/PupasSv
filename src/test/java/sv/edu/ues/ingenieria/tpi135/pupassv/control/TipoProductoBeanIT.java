...
public class TipoProductoBeanIT {
    ...
    @BeforeAll
    public void init() {
        System.out.println("Puerto expuesto: " + postgres.getMappedPort(5432));
    ...
    public void testCount() {
        System.out.println("Contar TipoProducto");
    ...
    public void testInsert() {
        System.out.println("Insertar TipoProducto");
        TipoProductoBean cut = new TipoProductoBean();
        EntityManager em = emf.createEntityManager();
        cut.em = em;
    ...
    public void testFindById() {
        System.out.println("Buscar TipoProducto por ID");
        TipoProductoBean cut = new TipoProductoBean();
        EntityManager em = emf.createEntityManager();
        cut.em = em;
    ...
    public void testFindRange() {
        System.out.println("Buscar rango de TipoProducto");
        TipoProductoBean cut = new TipoProductoBean();
        EntityManager em = emf.createEntityManager();
        cut.em = em;
    ...
    public void testUpdate() {
        ...
        TipoProducto tipoProducto = cut.findById(1); // <-- Integer
