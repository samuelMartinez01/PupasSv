...
public abstract class AbstractContainerTest {
     ...
     */
    private static MountableFile war = MountableFile.forHostPath(Paths.get("target/PupasSv-1.0-SNAPSHOT.war").toAbsolutePath());
     ...
     */
    @Container
    protected static final GenericContainer<?> openliberty = new GenericContainer<>("openliberty/open-liberty:latest")
