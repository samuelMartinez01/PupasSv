...
public class ProductoBeanIT {
    ...
    public void testFindByIdTipoProducto() {
        System.out.println("Buscar productos por tipo de producto");
    ...
    public void testCountByIdTipoProducto() {
        System.out.println("Contar productos por tipo de producto");
        ProductoBean cut = new ProductoBean();
        EntityManager em = emf.createEntityManager();
        cut.setEm(em);

        Integer cantidad = cut.countByIdTipoProducto(1, 0, 10);
        assertNotNull(cantidad);
        assertFalse(cantidad > 0);
    }
/**
    @Test
    @Order(3)
