...
public class ProductoDetalleBeanIT {
    ...
    public void testCount() {
        System.out.println("Contar ProductoDetalle");
        ProductoDetalleBean cut = new ProductoDetalleBean();
        EntityManager em = emf.createEntityManager();
        cut.em = em;

        // Aseguramos que haya al menos un registro en la tabla
        ProductoDetallePK pk = new ProductoDetallePK(1, 1L); // Ajusta los IDs si es necesario
        ...
        // Ahora que insertamos un dato, procedemos con el conteo
        Long esperado = 1L; // Esperamos 1 porque insertamos un producto
    ...
    public void testInsert() {
        System.out.println("Insertar ProductoDetalle");
        ProductoDetalleBean cut = new ProductoDetalleBean();
        EntityManager em = emf.createEntityManager();
        cut.em = em;
    ...
    public void testFindById() {
        System.out.println("Buscar ProductoDetalle por ID");
        ProductoDetalleBean cut = new ProductoDetalleBean();
        EntityManager em = emf.createEntityManager();
        cut.em = em;
    ...
    public void testFindRange() {
        System.out.println("Buscar rango de ProductoDetalle");
        ProductoDetalleBean cut = new ProductoDetalleBean();
        EntityManager em = emf.createEntityManager();
        cut.em = em;
    ...
    public void testUpdate() {
        System.out.println("Actualizar ProductoDetalle");
        ProductoDetalleBean cut = new ProductoDetalleBean();
        EntityManager em = emf.createEntityManager();
        cut.em = em;
    ...
    public void testDelete() {
        System.out.println("Eliminar ProductoDetalle");
        ProductoDetalleBean cut = new ProductoDetalleBean();
        EntityManager em = emf.createEntityManager();
        cut.em = em;

        ProductoDetallePK pk = new ProductoDetallePK(2, 2L); // usa un producto dummy
        ProductoDetalle nuevo = new ProductoDetalle(pk);
        nuevo.setActivo(true);
